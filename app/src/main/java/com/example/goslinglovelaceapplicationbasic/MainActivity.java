...
public class MainActivity extends AppCompatActivity {
    private ImageView imageView_Jams;
    private ImageView imageView_Ada;
    private TextView textView_Jams;
    private TextView textView_Ada;
...
//                    "He is known for his love of proving \"the unknown\" and has noted that his favorite irrational number is √2. He has a framed picture of the first 1,000 digits of √2 in his office.[20]");
            ...
            imageView_Ada.setImageResource(R.drawable.ada);
            textView_Ada=findViewById(R.id.textView_Ada);
//            textView_Ada.setText("Augusta Ada King, Countess of Lovelace (née Byron; 10 December 1815 – 27 November 1852) was an English mathematician and writer, chiefly known for her work on Charles Babbage's proposed mechanical general-purpose computer, the Analytical Engine. She was the first to recognise that the machine had applications beyond pure calculation, and published the first algorithm intended to be carried out by such a machine. As a result, she is sometimes regarded as the first to recognise the full potential of a \"computing machine\" and one of the first computer programmers.[2][3][4]\n" +
//                    "\n" +
